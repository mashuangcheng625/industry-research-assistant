  ...
  return (
    <div className={styles.thoughtBlock}>
      <div className={styles.blockHeader}>
        {step && <span className={styles.stepBadge}>步骤 {step}</span>}
        <span className={styles.blockLabel}>分析</span>
      </div>
...
function ActionBlock(props: {
  ...
  return (
    <div className={styles.actionBlock}>
      <div className={styles.blockHeader}>
        {step && <span className={styles.stepBadge}>步骤 {step}</span>}
        <span className={styles.blockLabel}>执行研究任务</span>
